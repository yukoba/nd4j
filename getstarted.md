...
You'll also need to specify a backend dependency. (You can copy all the dependencies from [one text file](../pomtext.txt) into your POM, if that's more convenient, and simply comment out the ones you don't wan't.)
