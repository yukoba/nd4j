 ...
 * @author Adam Gibson
 */
public class OpenClDoubleDataBuffer extends BaseOpenClDataBuffer {
     ...
     */
    public OpenClDoubleDataBuffer(int length) {
        super(length, Sizeof.cl_double);
        if (pointer() == null)
            alloc();
    }
     ...
     */
    public OpenClDoubleDataBuffer(double[] data) {
        this(data.length);
        setData(data);
    }
    ...
    public DataBuffer dup() {
        ...
        OpenClDoubleDataBuffer buffer = new OpenClDoubleDataBuffer(length());
        copyTo(buffer);
        return buffer;
    }
