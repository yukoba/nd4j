 ...
 * @author Adam Gibson
 */
public class OpenClIntDataBuffer extends BaseOpenClDataBuffer {
    /**
     * Base constructor
     *
     * @param length the length of the buffer
     */
    public OpenClIntDataBuffer(int length) {
        super(length, Sizeof.cl_int);
    }

    public OpenClIntDataBuffer(int[] data) {
        this(data.length);
        setData(data);
    }
